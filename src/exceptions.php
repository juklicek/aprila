...
namespace Aprila;
	 ...
	 *         - Aprila\InvalidStateException
	 *         - Aprila\DuplicateEntryException
	 *         - Aprila\IOException
	 *             - Aprila\FileNotFoundException
	 *             - Aprila\DirectoryNotFoundException
	 *     - LogicException = chyba v kódu, který volá metodu, která tuto výjimku vyhodila; lze jí předejít
	 *         - InvalidArgumentException
	 *             - Aprila\InvalidArgumentException
	 *                 - Aprila\ArgumentOutOfRangeException
	 *         - Aprila\NotImplementedException
	 *         - Aprila\NotSupportedException
	 *             - Aprila\DeprecatedException
	 *         - Aprila\StaticClassException
	 *
	 * @author Jan Tvrdík
	 */
